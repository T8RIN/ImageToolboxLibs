...
dependencies {
    ...
    implementation(projects.dynamicTheme)
    implementation(projects.androidwm)
    implementation(projects.awebp)
    implementation(projects.qoiCoder)
    implementation(projects.tiffdecoder)
    implementation(projects.systemuicontroller)
    implementation(projects.jp2decoder)
    implementation(projects.psd)
    implementation(projects.cropper)
