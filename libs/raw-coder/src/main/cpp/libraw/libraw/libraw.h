...
public:
    ...
    libraw_output_params_t *output_params_ptr() {
    ...
    int error_count() {
        return libraw_internal_data.unpacker_data.data_error;
    }
    ...
    static float libraw_powf64l(float a, float b) {
