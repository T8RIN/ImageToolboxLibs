...
const char *LibRaw::strerror(int p) {
    return libraw_strerror(p);
}
...
checked_buffer_t::checked_buffer_t(short ord, unsigned char *dd, int ss)
        : _order(ord), _data(dd), _len(ss) {
}
