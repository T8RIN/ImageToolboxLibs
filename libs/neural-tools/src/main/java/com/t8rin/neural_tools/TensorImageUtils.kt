...
/**
 * Contains utility functions for [Tensor] creation from [Bitmap] or
 * [android.media.Image] source.
 */
internal object TensorImageUtils {
    val TORCHVISION_NORM_MEAN_RGB: FloatArray = floatArrayOf(0.485f, 0.456f, 0.406f)
    val TORCHVISION_NORM_STD_RGB: FloatArray = floatArrayOf(0.229f, 0.224f, 0.225f)

    /**
     * Creates new [Tensor] from full [Bitmap], normalized with specified
    ...
    fun bitmapToFloat32Tensor(
        bitmap: Bitmap,
        normMeanRGB: FloatArray = TORCHVISION_NORM_MEAN_RGB,
        normStdRGB: FloatArray? = TORCHVISION_NORM_STD_RGB
    ): Tensor {
    ...
    /**
     * Writes tensor content from specified [Bitmap], normalized with specified
     * in parameters mean and std to specified [FloatBuffer] with specified offset.
     *
     * @param bitmap      [Bitmap] as a source for Tensor data
    ...
    /**
     * Creates new [Tensor] from specified area of [Bitmap], normalized
...
fun Bitmap.toTensor() = TensorImageUtils.bitmapToFloat32Tensor(this)