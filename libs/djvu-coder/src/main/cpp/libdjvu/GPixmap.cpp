        ...
        while (dx < destwidth) {
            ...
            if (dx >= 0 && dy >= 0 && dx + 3 <= destwidth && dy + 3 <= destheight) {
                if (sx + 4 <= srcwidth && sy + 4 <= srcheight) {
                    ...
                    copy_from_partial(4, 4, sptr + sx, sadd, -sx, srcwidth - sx, -sy,
                                      srcheight - sy, xin, 4);
                ...
                if (sx + 4 <= srcwidth && sy + 4 <= srcheight) {
                    ...
                    copy_to_partial(3, 3, xout, 3, dptr + dx, dadd, -dx, destwidth - dx, -dy,
                                    destheight - dy);
                } else {
                    copy_from_partial(4, 4, sptr + sx, sadd, -sx, srcwidth - sx, -sy,
                                      srcheight - sy, xin, 4);
        ...
        while (dx < destwidth) {
            ...
            if (dx >= 0 && dy >= 0 && dx + 3 <= destwidth && dy + 3 <= destheight) {
                if (sx + 2 <= srcwidth && sy + 2 <= srcheight) {
                    ...
                    copy_from_partial(2, 2, sptr + sx, sadd, -sx, srcwidth - sx, -sy,
                                      srcheight - sy, xin, 2);
