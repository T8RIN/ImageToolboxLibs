...
public:
    ...
    static void AddByteStreamLater(const GP<ByteStream> &bs) {
        use_language();
        DjVuMessageLite::AddByteStreamLater(bs);
    }
    ...
    static GUTF8String LookUpUTF8(const GUTF8String &MessageList) {
        use_language();
        return DjVuMessageLite::LookUpUTF8(MessageList);
    }
