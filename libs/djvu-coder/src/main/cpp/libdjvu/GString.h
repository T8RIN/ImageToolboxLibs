...
public:
    enum EncodeType {
        XUCS4, XUCS4BE, XUCS4LE, XUCS4_2143, XUCS4_3412,
        XUTF16, XUTF16BE, XUTF16LE, XUTF8, XEBCDIC, XOTHER
    };

    enum EscapeMode {
        UNKNOWN_ESCAPED = 0, IS_ESCAPED = 1, NOT_ESCAPED = 2
    };
...
public:
    ...
    */
    ...
    static int UTF8toUCS4(
        ...
        w = UTF8toUCS4(r, endptr);
        return (int) ((size_t) r - (size_t) s);
    }
...
inline void
GUTF8String::init(void) { GBaseString::init(); }

inline GUTF8String &
GUTF8String::init(const GP<GStringRep> &rep) {
    GP<GStringRep>::operator=(rep ? rep->toUTF8(true) : rep);
    init();
    return *this;
}
...
inline
GUTF8String::GUTF8String(const GP<GStringRep> &str) { init(str ? (str->toUTF8(true)) : str); }
...
/** Returns an integer.  Implements i18n atoi.  */
inline int
GBaseString::toInt(void) const { return ptr ? (*this)->toInt() : 0; }
...
inline int
GBaseString::search(char c, int from) const { return ptr ? ((*this)->search(c, from)) : (-1); }
...
inline int
GBaseString::cmp(const char *s2, const int len) const { return GStringRep::cmp(*this, s2, len); }

inline int
GBaseString::cmp(const char s2) const { return GStringRep::cmp(*this, &s2, 1); }
...
inline bool
GBaseString::operator==(const GBaseString &s2) const { return !cmp(s2); }

inline bool
GBaseString::operator==(const char *s2) const { return !cmp(s2); }
...
inline bool
GBaseString::operator>=(const GBaseString &s2) const { return (cmp(s2) >= 0); }

inline bool
GBaseString::operator>=(const char *s2) const { return (cmp(s2) >= 0); }
...
inline int
GBaseString::nextChar(const int from) const { return ptr ? (*this)->nextChar(from) : 0; }
...
inline bool
GBaseString::is_valid(void) const { return ptr ? ((*this)->is_valid()) : true; }
...
inline GUTF8String::GUTF8String(const GUTF8String &str) { init(str); }

inline GUTF8String &GUTF8String::operator=(const GP<GStringRep> &str) { return init(str); }

inline GUTF8String &GUTF8String::operator=(const GBaseString &str) { return init(str); }

inline GUTF8String &GUTF8String::operator=(const GUTF8String &str) { return init(str); }

inline GUTF8String &GUTF8String::operator=(const GNativeString &str) { return init(str); }
...
inline bool
operator==(const char *s1, const GBaseString &s2) { return !s2.cmp(s1); }

inline bool
operator!=(const char *s1, const GBaseString &s2) { return !!s2.cmp(s1); }

inline bool
operator>=(const char *s1, const GBaseString &s2) { return (s2.cmp(s1) <= 0); }
...
inline bool
operator<=(const char *s1, const GBaseString &s2) { return !(s1 > s2); }
