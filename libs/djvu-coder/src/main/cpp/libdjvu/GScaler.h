...
public:
    ...
    static GP<GBitmapScaler> create(
            const int inw, const int inh, const int outw,
            const int outh) { return new GBitmapScaler(inw, inh, outw, outh); }
...
public:
    ...
    static GP<GPixmapScaler> create(
            const int inw, const int inh, const int outw,
            const int outh) { return new GPixmapScaler(inw, inh, outw, outh); }
