...
public:
    ...
    static GP<GPixmap> create(const GBitmap &ref) { return new GPixmap(ref); }
    ...
    static GP<GPixmap> create(const GPixmap &ref) { return new GPixmap(ref); }
    ...
    static GP<GPixmap> create(ByteStream &ref) { return new GPixmap(ref); }
