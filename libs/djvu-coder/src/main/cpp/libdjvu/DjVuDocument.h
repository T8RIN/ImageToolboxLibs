...
public:
    ...
    \end{itemize} */
    enum DOC_FLAGS {
        DOC_TYPE_KNOWN = 1, DOC_DIR_KNOWN = 2,
    ...
    \begin{enumerate}
       ...
       \item #INDIRECT# - Currently supported "expanded" format, where
        ...
        \end{enumerate} */
    enum DOC_TYPE {
        OLD_BUNDLED = 1, OLD_INDEXED, BUNDLED, INDIRECT,
...
public:
    ...
    */
    ...
    GUTF8String page_to_id(int page_num) const { return url_to_id(page_to_url(page_num)); }
    ...
    GUTF8String url_to_id(const GURL &url) const { return url.fname(); }
    ...
    int id_to_page(const GUTF8String &id) const { return url_to_page(id_to_url(id)); }
