    ...
    private void rebuildGradient() {
        ...
        for (int i = 1; i < numKnots - 1; i++) {
            ...
            for (int j = xKnots[i]; j < end; j++) {
                ...
                Color.RGBToHSV((rgb1 >> 16) & 0xff, (rgb1 >> 8) & 0xff, rgb1 & 0xff, hsb1);
                float[] hsb2 = new float[3];
                Color.RGBToHSV((rgb2 >> 16) & 0xff, (rgb2 >> 8) & 0xff, rgb2 & 0xff, hsb2);
...
//					if (blend != SPLINE) {
                    switch (type) {
                        ...
                        case HUE_CCW:
                            ...
                            float[] hsv = {ImageMath.lerp(t, hsb1[0], hsb2[0]) % (ImageMath.TWO_PI),
                                    ImageMath.lerp(t, hsb1[1], hsb2[1]),
                                    ImageMath.lerp(t, hsb1[2], hsb2[2])};
							/*
							...
							*/
                            ...
                            map[j] = 0xff000000 | Color.HSVToColor(hsv);//FIXME-alpha
                            break;
                    }
//					}
                }
