...
DEFINE_GUID(IID_ID2D1DeviceContext1,
0xd37f57e4, 0x6908, 0x459f, 0xa1, 0x99, 0xe7, 0x2f, 0x24, 0xf7, 0x99, 0x87);
MIDL_INTERFACE("d37f57e4-6908-459f-a199-e72f24f79987")
ID2D1DeviceContext1 : public ID2D1DeviceContext
{
virtual void STDMETHODCALLTYPE

CreateFilledGeometryRealization() = 0;

virtual void STDMETHODCALLTYPE

CreateStrokedGeometryRealization() = 0;

virtual void STDMETHODCALLTYPE

DrawGeometryRealization() = 0;

};
__CRT_UUID_DECL(ID2D1DeviceContext1,
0xd37f57e4, 0x6908, 0x459f, 0xa1, 0x99, 0xe7, 0x2f, 0x24, 0xf7, 0x99, 0x87)
...
CreateGradientMesh() = 0;

virtual void STDMETHODCALLTYPE

CreateImageSourceFromWic() = 0;

virtual void STDMETHODCALLTYPE

CreateLookupTable3D() = 0;

virtual void STDMETHODCALLTYPE

CreateImageSourceFromDxgi() = 0;

virtual void STDMETHODCALLTYPE

GetGradientMeshWorldBounds() = 0;
...
CreateTransformedImageSource() = 0;

};
__CRT_UUID_DECL(ID2D1DeviceContext2,
0x394ea6a3, 0x0c34, 0x4321, 0x95, 0x0b, 0x6c, 0xa2, 0x0f, 0x0b, 0xe6, 0xc7)
...
__CRT_UUID_DECL(ID2D1DeviceContext3,
0x235a7496, 0x8351, 0x414c, 0xbc, 0xd4, 0x66, 0x72, 0xab, 0x2d, 0x8e, 0x00)
...
__CRT_UUID_DECL(ID2D1SvgGlyphStyle,
0xaf671749, 0xd241, 0x4db8, 0x8e, 0x41, 0xdc, 0xc2, 0xe5, 0xc1, 0xa4, 0x38)
...
__CRT_UUID_DECL(ID2D1DeviceContext4,
0x8c427831, 0x3d90, 0x4476, 0xb6, 0x47, 0xc4, 0xfa, 0xe3, 0x49, 0xe4, 0xdb)
