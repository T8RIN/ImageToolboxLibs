...
data class FractalRenderRequest(
    ...
    val maxIterations: Int = type.defaultMaxIterations,
    val power: Double = type.defaultPower,
    val bailout: Double = type.defaultBailout,
    ...
    val juliaReal: Double = type.defaultJuliaReal,
    val juliaImaginary: Double = type.defaultJuliaImaginary,
    val phoenixReal: Double = type.defaultPhoenixReal,
    val phoenixImaginary: Double = type.defaultPhoenixImaginary,
