...
JNIEXPORT jboolean JNICALL Java_org_beyka_tiffbitmapfactory_TiffConverter_convertTiffPngFd
    ...
    TiffToPngConverter *converter = new TiffToPngConverter(env, clazz, tiffFd, pngFd, options,
                                                           listener);
    jboolean result = converter->convert();
    delete (converter);
    return result;
...
JNIEXPORT jboolean JNICALL Java_org_beyka_tiffbitmapfactory_TiffConverter_convertTiffJpg
        (JNIEnv *env, jclass clazz, jstring tiffPath, jstring jpgPath, jobject options,
         jobject listener) {

    TiffToJpgConverter *converter = new TiffToJpgConverter(env, clazz, tiffPath, jpgPath, options,
                                                           listener);
    jboolean result = converter->convert();
    delete (converter);
    return result;
...
JNIEXPORT jboolean JNICALL Java_org_beyka_tiffbitmapfactory_TiffConverter_convertTiffJpgFd
    ...
    TiffToJpgConverter *converter = new TiffToJpgConverter(env, clazz, tiffFd, jpgFd, options,
                                                           listener);
    jboolean result = converter->convert();
    delete (converter);
    return result;
...
JNIEXPORT jboolean JNICALL Java_org_beyka_tiffbitmapfactory_TiffConverter_convertTiffBmp
        (JNIEnv *env, jclass clazz, jstring tiffPath, jstring outPath, jobject options,
         jobject listener) {

    TiffToBmpConverter *converter = new TiffToBmpConverter(env, clazz, tiffPath, outPath, options,
                                                           listener);
    jboolean result = converter->convert();
    delete (converter);
    return result;
...
JNIEXPORT jboolean JNICALL Java_org_beyka_tiffbitmapfactory_TiffConverter_convertTiffBmpFd
    ...
    TiffToBmpConverter *converter = new TiffToBmpConverter(env, clazz, tiffFd, bmpFd, options,
                                                           listener);
    jboolean result = converter->convert();
    delete (converter);
    return result;
...
JNIEXPORT jboolean JNICALL Java_org_beyka_tiffbitmapfactory_TiffConverter_convertPngTiffFd
    ...
    PngToTiffConverter *converter = new PngToTiffConverter(env, clazz, pngFd, tiffFd, options,
                                                           listener);
    jboolean result = converter->convert();
    delete (converter);
    return result;
...
JNIEXPORT jboolean JNICALL Java_org_beyka_tiffbitmapfactory_TiffConverter_convertJpgTiffFd
    ...
    JpgToTiffConverter *converter = new JpgToTiffConverter(env, clazz, jpgFd, tiffFd, options,
                                                           listener);
    jboolean result = converter->convert();
    delete (converter);
    return result;
...
JNIEXPORT jboolean JNICALL Java_org_beyka_tiffbitmapfactory_TiffConverter_convertBmpTiff
        (JNIEnv *env, jclass clazz, jstring bmpPath, jstring tiffPath, jobject options,
         jobject listener) {
    BmpToTiffConverter *converter = new BmpToTiffConverter(env, clazz, bmpPath, tiffPath, options,
                                                           listener);
    jboolean result = converter->convert();
    delete (converter);
    return result;
...
JNIEXPORT jboolean JNICALL Java_org_beyka_tiffbitmapfactory_TiffConverter_convertBmpTiffFd
    ...
    BmpToTiffConverter *converter = new BmpToTiffConverter(env, clazz, bmpFd, tiffFd, options,
                                                           listener);
    jboolean result = converter->convert();
    delete (converter);
    return result;
...
JNIEXPORT jobject JNICALL Java_org_beyka_tiffbitmapfactory_TiffConverter_readBmp
        (JNIEnv *env, jclass clazz, jstring tiffPath, jstring bmpPath, jobject options,
         jobject listener) {
