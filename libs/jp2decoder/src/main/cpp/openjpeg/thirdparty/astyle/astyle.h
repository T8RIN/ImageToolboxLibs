...
//----------------------------------------------------------------------------
    ...
    enum FileType {
        C_TYPE = 0, JAVA_TYPE = 1, SHARP_TYPE = 2
    };
...
//-----------------------------------------------------------------------------
    ...
    public:
        ...
        ~ASPeekStream() { if (needReset) sourceIterator->peekReset(); }

        bool hasMoreLines() const { return sourceIterator->hasMoreLines(); }
...
//-----------------------------------------------------------------------------
    ...
    public:
        ...
        void
        buildIndentableMacros(vector<const pair<const string, const string> *> *indentableMacros);
        ...
        void buildNonParenHeaders(vector<const string *> *nonParenHeaders, int fileType,
...
//-----------------------------------------------------------------------------
    ...
    private:  // functions
        ...
        const string &
        getIndentedLineReturn(const string &newLine, const string &originalLine) const;
