...
//----------------------------------------------------------------------------
    ...
    private:
        ASStreamIterator(
                const ASStreamIterator &copy);       // copy constructor not to be implemented
        ASStreamIterator &
        operator=(ASStreamIterator &);       // assignment operator not to be implemented
...
//----------------------------------------------------------------------------
    ...
    private:
        ...
        enum eState {
            eStart, eSecondOf4Bytes, ePenultimate, eFinal
        };
