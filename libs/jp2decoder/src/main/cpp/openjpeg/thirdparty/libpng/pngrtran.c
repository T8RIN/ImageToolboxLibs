                ...
                if (row_info->bit_depth == 8) {
...
#endif
                    {
                        ...
                        for (i = 0; i < row_width; i++, sp += 2) {
                            ...
                            else if (a < 0xff) png_composite(*sp, *sp, a, png_ptr->background.gray);
                        }
                    }
                ...
                if (row_info->bit_depth == 2) {
                    ...
                    for (i = 0; i < row_width; i += 4) {
                        ...
                        *sp = (png_byte)(
                                ...
                                ((((int) gamma_table[(b << 2) | b | (b >> 2) | (b >> 4)]) >> 2) &
                                 0x30) |
                                ((((int) gamma_table[(c << 4) | (c << 2) | c | (c >> 2)]) >> 4) &
                                 0x0c) |
