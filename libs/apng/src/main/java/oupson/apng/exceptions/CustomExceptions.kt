...
class InvalidFrameSizeException(
    animationWidth: Int,
    animationHeight: Int,
    frameWidth: Int,
    frameHeight: Int,
    ...
    override val message: String = when {
        ...
        animationHeight != frameHeight && isFirstFrame -> {
...
class BadBitmapsDiffSize(
    firstBitmapWidth: Int,
    firstBitmapHeight: Int,
    secondBitmapWidth: Int,
    secondBitmapHeight: Int
) : Exception() {
    override val message: String =
        "${firstBitmapWidth}x${firstBitmapHeight} must be bigger than or equal to ${secondBitmapWidth}x${secondBitmapHeight}"
}
