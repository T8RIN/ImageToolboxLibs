...
// build the translation vector in the Translation base class
    {
        ...
        addPair("For help on options type 'astyle -h'",
                L"Voor hulp bij 'astyle-h' opties het type");
        ...
        addPair("Did you intend quote the filename",
                L"Heeft u van plan citaat van de bestandsnaam");
        addPair("No file to process %s\n", L"Geen bestand te verwerken %s\n");
        addPair("Did you intend to use --recursive",
                L"Hebt u van plan bent te gebruiken --recursive");
...
// build the translation vector in the Translation base class
    {
        ...
        addPair("For help on options type 'astyle -h'",
                L"Pour de l'aide sur les options tapez 'astyle -h'");
        ...
        addPair("Did you intend quote the filename",
                L"Avez-vous l'intention de citer le nom de fichier");
        addPair("No file to process %s\n", L"Aucun fichier à traiter %s\n");
        addPair("Did you intend to use --recursive",
                L"Avez-vous l'intention d'utiliser --recursive");
...
// build the translation vector in the Translation base class
    {
        ...
        addPair("For help on options type 'astyle -h'",
                L"Für Hilfe zu den Optionen geben Sie 'astyle -h'");
        ...
        addPair("Did you intend quote the filename",
                L"Haben Sie die Absicht Inhalte der Dateiname");
...
// build the translation vector in the Translation base class
    {
        ...
        addPair("For help on options type 'astyle -h'",
                L"Ha segítségre van lehetőség típus 'astyle-h'");
...
// build the translation vector in the Translation base class
    {
        ...
        addPair("For help on options type 'astyle -h'",
                L"Per informazioni sulle opzioni di tipo 'astyle-h'");
...
// build the translation vector in the Translation base class
    {
        ...
        addPair("For help on options type 'astyle -h'",
                L"For hjelp til alternativer type 'astyle -h'");
...
// build the translation vector in the Translation base class
    {
        ...
        addPair("For help on options type 'astyle -h'",
                L"Aby uzyskać pomoc od rodzaju opcji 'astyle -h'");
...
// build the translation vector in the Translation base class
    {
        ...
        addPair("For help on options type 'astyle -h'",
                L"Para obter ajuda sobre as opções de tipo 'astyle -h'");
        ...
        addPair("Did you intend quote the filename",
                L"Será que você pretende citar o nome do arquivo");
...
// build the translation vector in the Translation base class
    {
        ...
        addPair("For help on options type 'astyle -h'",
                L"Pentru ajutor cu privire la tipul de opțiuni 'astyle -h'");
        ...
        addPair("Did you intend to use --recursive",
                L"V-ați intenționați să utilizați --recursive");
...
// build the translation vector in the Translation base class
    {
        ...
        addPair("For help on options type 'astyle -h'",
                L"Para obtener ayuda sobre las opciones tipo 'astyle -h'");
        ...
        addPair("Did you intend quote the filename",
                L"Se tiene la intención de citar el nombre de archivo");
