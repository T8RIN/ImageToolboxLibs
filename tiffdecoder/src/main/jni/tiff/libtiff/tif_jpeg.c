...
JPEGVSetField(TIFF *tif, ttag_t tag, va_list ap) {
    ...
    switch (tag) {
        case TIFFTAG_JPEGTABLES:
            ...
            _TIFFsetByteArray(&sp->jpegtables, va_arg(ap,
            void*),
            (long) v32);
        ...
        case TIFFTAG_JPEGQUALITY:
            sp->jpegquality = va_arg(ap,
            int);
            return (1);            /* pseudo tag */
        case TIFFTAG_JPEGCOLORMODE:
            sp->jpegcolormode = va_arg(ap,
            int);
        ...
        case TIFFTAG_FAXSUBADDRESS:
            _TIFFsetString(&sp->subaddress, va_arg(ap,
            char*));
            break;
        case TIFFTAG_FAXRECVTIME:
            ...
            break;
        case TIFFTAG_FAXDCS:
            _TIFFsetString(&sp->faxdcs, va_arg(ap,
            char*));
            break;
        default:
            return (*sp->vsetparent)(tif, tag, ap);
